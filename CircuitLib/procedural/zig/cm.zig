...
pub extern "env" fn createBlockAtPosition(x: cord_t, y: cord_t, rotation: Rotation, blockType: BlockType) block_id_t;
...
pub extern "env" fn addConnectionInput(external_port_x: cord_t, external_port_y: cord_t, internal_block_id: block_id_t, internal_port_id: connection_end_id_t) void;
pub extern "env" fn addConnectionOutput(external_port_x: cord_t, external_port_y: cord_t, internal_block_id: block_id_t, internal_port_id: connection_end_id_t) void;

pub extern "env" fn setSize(width: cord_t, height: cord_t) void;
