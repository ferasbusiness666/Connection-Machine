...
CircuitView::CircuitView(Environment* environment, ViewportId viewportId) : viewportId(viewportId), toolManager(environment, &eventRegister, viewportId, this), tutorialManager(environment, this) {
