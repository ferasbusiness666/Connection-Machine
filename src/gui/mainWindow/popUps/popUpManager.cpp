...
void PopUpManager::aboutConnectionMachine() {
	...
	Rml::Element* window = windowList.front();
	window->SetAttribute("style", "display: flex; flex-direction: row; width: 40.625em; height: 31.25em; background-color:#303030;");
	...
	body2->SetInnerRML("github: https://github.com/Martian-Technologies/Connection-Machine <br />  \
	...
	close->AddEventListener(Rml::EventId::Click, new EventPasser([deleteFunc = closePopup](Rml::Event& event) { deleteFunc(); }));
