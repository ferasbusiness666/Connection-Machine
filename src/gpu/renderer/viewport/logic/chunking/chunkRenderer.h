...
public:
	...
	void render(Frame& frame, const glm::mat4& viewMatrix, const Evaluator* evaluator, const Address& address, const std::vector<std::shared_ptr<VulkanLogicAllocation>>& chunks);
